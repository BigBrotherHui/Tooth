...
#ifndef PointSetVtkMapper3D_h
#define PointSetVtkMapper3D_h
...
class vtkTransformPolyDataFilter;
  ...
  * @ingroup Mapper
  */
  class PointSetVtkMapper3D : public mitk::VtkMapper
  {
  public:
    mitkClassMacro(PointSetVtkMapper3D, mitk::VtkMapper);
  ...
  protected:
    ...
    mitk::ScalarType m_PointSize;
    mitk::ScalarType m_ContourRadius;
  };
